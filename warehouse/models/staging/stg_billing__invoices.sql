...
shaped as (
    select
        ...
        -- from its totals, never summed). The door enforces the same list, generated by
        -- the same script from the same published table — which this repo does NOT ship
        -- (see vendor/iso-4217/README.md). This is blast-radius containment for rows that reached raw
